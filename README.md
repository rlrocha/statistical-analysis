...
[<img src="https://img.shields.io/badge/author-rlrocha-orange?style=flat-square"/>](https://github.com/rlrocha)
 ...
 1. Realizar o teste de Grubb para investigar a hipótese de amostras *outliers* na distribuição dos dados. Se a hipótese da amostra ser *outlier* não for rejeitada, a amostra é então removida para o teste de normalidade subsequente.
